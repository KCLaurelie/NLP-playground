...
import os
data_folder=r'C:\Users\K1774755\Desktop\New folder\SharePoint\Cognitive Impairment in Schiz - Doc\Courses\CUSMUMH\week 7 - NLP with nltk & spacy'
...
glove = KeyedVectors.load_word2vec_format(os.path.join(data_folder,'glove.twitter.27B.25d.txt.bz2'), binary=False)
print("Done loading")
