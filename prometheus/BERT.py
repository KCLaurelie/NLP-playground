...
Original file is located at
    https://colab.research.google.com/drive/1MjfFlH-Fa-6sFZ0HzMdFr0rXZEbYICA6
"""
...
BERT_tokenizer = 'monologg/biobert_v1.0_pubmed_pmc'
df = pd.read_csv('gdrive/My Drive/prometheus/datasets/mimic_status_10folds.csv')
...
probs = np.exp(preds_curr)/(1+np.exp(preds_curr))
print(probs, '\n',
      np.max(probs,axis=1)
)